...
/*-------------------------------------------------------------------*/
public class Waypoint implements Serializable, GameObject
{
	private Vector3f pos = null;
	private boolean locked = false;
	private Vector edges = new Vector();
	
	private Vector edgesFailureScore = new Vector();
...
/*-------------------------------------------------------------------*/
	...
	{
		return !locked && edgesFailureScore.remove(edges.indexOf(node)) != null 
		&& edges.remove(node);
	}
...
/*-------------------------------------------------------------------*/
	...
	{
		return !locked && edgesFailureScore.remove(index) != null
		&& edges.remove(index) != null;
	}
...
/*-------------------------------------------------------------------*/
	...
	public String toString() {
		return "WP@"+pos.toString();
	}
	
@Override
public String toDetailedString() {
	return "wp position: "+pos.toString()+"\n"+
