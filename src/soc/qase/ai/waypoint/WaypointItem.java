 ...
 *	@see WaypointMap */
/*-------------------------------------------------------------------*/
public class WaypointItem implements Serializable, GameObject
{
	
	/**
	 * Maximum allowed respawn fail count to still consider the item respawnable.
	 */
	public static int maximalRespawnFailCount = 10;
